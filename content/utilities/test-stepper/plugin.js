...
const buildStepper = (stepObj, classObj) => {
...
// Need to pass class instance in order to update variables.
// Append to the DOM in given order.
const buildDropdown = (dropObj, classObj) => {
...
const appendListToDom = (container, eltList) => {
    try {
...
const buildUi = (container, objList, classObj) => {
    let elements = [];
